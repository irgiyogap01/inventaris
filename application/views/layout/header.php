...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="<?=base_url('assets/')?>images/ptpn5.png" width="50" height="50" class="brand-image img">
      <span class="brand-text font-weight-light">PTPN V</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">NAVIGATION MASTER</li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?= site_url('Au31');?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= base_url('Auth/logout');?>" class="nav-link btn-danger">
